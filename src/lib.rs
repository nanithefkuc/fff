...
//! towers `Gf32`/`Gf64` run the same tower identity on x86 GFNI; on every
//! other target they and the canonical Fan–Paar family use the portable
//! kernels. All types share the same checked [`ops`] surface and stable
